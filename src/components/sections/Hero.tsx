...
const HERO_TEXTS: Record<HeroContentKey, { title: string; subtitle: string; ctaPrimary: string; ctaSecondary: string; ctaPrimaryHref: string; ctaSecondaryHref: string; stats: string }> = {
  ...
  "uslugi.hero": { title: "Nowoczesne strony i sklepy internetowe.", subtitle: "Projektujemy szybkie i skuteczne strony dla mikro i małych firm. Jasna wycena. Bez chaosu.", ctaPrimary: "Sprawdź koszt w 60 sekund", ctaSecondary: "Umów bezpłatną konsultację", ctaPrimaryHref: "/kalkulator", ctaSecondaryHref: "/kontakt", stats: "" },
  "realizacje.hero": { title: "Zobacz nasze realizacje.", subtitle: "Strony zaprojektowane pod realne wyniki.", ctaPrimary: "Sprawdź koszt swojej strony", ctaSecondary: "Umów bezpłatną konsultację", ctaPrimaryHref: "/kalkulator", ctaSecondaryHref: "/kontakt", stats: "" },
  "proces.hero": { title: "Proces współpracy", subtitle: "Prosto. Transparentnie. Bez chaosu.", ctaPrimary: "Rozpocznij wycenę", ctaSecondary: "Umów bezpłatną konsultację", ctaPrimaryHref: "/kalkulator", ctaSecondaryHref: "/kontakt", stats: "" },
  "kalkulator.hero": { title: "Sprawdź koszt realizacji w 60 sekund.", subtitle: "Wybierz zakres projektu i zobacz szacunkową wycenę.", ctaPrimary: "Przejdź do kalkulatora", ctaSecondary: "Umów bezpłatną konsultację", ctaPrimaryHref: "#kalkulator-form", ctaSecondaryHref: "/kontakt", stats: "" },
  "kontakt.hero": { title: "Porozmawiajmy o Twojej stronie.", subtitle: "Umów bezpłatną konsultację.", ctaPrimary: "Umów konsultację", ctaSecondary: "Sprawdź koszt w kalkulatorze", ctaPrimaryHref: "#formularz-kontaktowy", ctaSecondaryHref: "/kalkulator", stats: "" },
        ...
        >
          ...
          {titleHighlight && (
            <span
              ...
              style={{
                backgroundImage: "linear-gradient(90deg, var(--color-primary), var(--color-accent-2))",
