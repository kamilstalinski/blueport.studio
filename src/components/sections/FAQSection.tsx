...
const FAQ_ITEMS: Record<string, { q: string; a: string }> = {
  price: { q: "Ile kosztuje strona internetowa?", a: "Proste strony firmowe zaczynają się od 2 500 zł. Sklepy internetowe od 4 900 zł. Dokładną wycenę sprawdzisz w kalkulatorze." },
  time: { q: "Ile trwa realizacja?", a: "Strona firmowa lub sklep do 30 produktów: zwykle 2–4 tygodnie. Większe projekty ustalamy indywidualnie po wycenie." },
